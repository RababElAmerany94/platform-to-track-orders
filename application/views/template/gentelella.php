    ...
    <body class="nav-md">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#main-table-box table').addClass('table table-striped jambo_table bulk_action');
                $('#main-table-box .bDiv').addClass('table-responsive');
                $('#main-table-box').parent().removeClass('flexigrid');
                $('#main-table-box .tDiv').addClass('flexigrid');
                $('#filtering_form').addClass('flexigrid');
                $('#main-table-box table .tools').addClass('flexigrid');
                $('#main-table-box table .tools a').addClass('btn btn-default');
            });
        </script>
    </body>
</html>
